...
default_placeholder = "Enter text to search."
    ...
    def render(self, name, value, attrs=None, renderer=None, **_kwargs):
        ...
        if value:
            ...
            try:
                ...
                raise Exception(f"{lookup} cannot find object:{value}") from exc
...
class AutoCompleteSelectField(forms.fields.CharField):
    ...
    def __init__(self, channel, *args, **kwargs):
        ...
        widget_kwargs = dict(
            ...
            placeholder=kwargs.get("placeholder", _(default_placeholder)),
...
class AutoCompleteSelectMultipleField(forms.fields.CharField):
    ...
    def __init__(self, channel, *args, **kwargs):
        ...
        widget_kwargs = {
            "channel": channel,
            "help_text": help_text,
            "placeholder": kwargs.pop("placeholder", default_placeholder),
    ...
    def has_changed(self, initial, data):
        # [1, 2] vs [u'1', u'2']
        ivs = [str(v) for v in (initial or [])]
        dvs = [str(v) for v in (data or [])]
        return ivs != dvs
...
class AutoCompleteField(forms.CharField):
    ...
    def __init__(self, channel, *args, **kwargs):
        ...
        widget_kwargs = dict(
            help_text=kwargs.get("help_text", _(default_placeholder)),
            show_help_text=kwargs.pop("show_help_text", True),
            plugin_options=kwargs.pop("plugin_options", {}),
        )
        widget_kwargs.update(kwargs.pop("widget_options", {}))
